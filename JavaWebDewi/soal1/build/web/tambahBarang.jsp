     ...
     <ul>
        ...
        <li><a href='index.jsp'>Home</a></li>
			...
			<tr rowspan='7'>
				...
				<td>
        <form action="UserController_master?data=user&proses=input-user" method="post" name="dewi">    
				...
				<td>Harga Beli</td><td><input type='text' name='harga_beli'></td>
                                ...
                                <tr>
                                    ...
                                    <td><button type='button' onClick="hgJual(this.form)">Harga Jual</button></td>
                                    <td><input type='text' name='harga_jual'></td>
                                    
				</tr>
                                <script type="text/javascript">
                                    function hgJual(form){
                                        var hrBeli = (document.dewi.harga_beli.value);
                                        var hrJual = hrBeli * 0.25;
                                        var jual = (parseInt(hrBeli)+parseInt(hrJual));
                                        document.dewi.harga_jual.value = jual;
                                    }
                                    </script>
				<tr>
